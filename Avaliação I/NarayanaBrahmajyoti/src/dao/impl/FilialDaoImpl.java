...
public class FilialDaoImpl implements IDao<Filial> {
    ...
    public Filial salvar(Filial filial) {
        ...
        String query = String.format("INSERT INTO filiais(filial,rua,numero,cidade,estado,eh5estrelas) " +
                        "VALUES('%s','%s','%s','%s','%s','%s')",
                filial.getFilial(), filial.getRua(), filial.getNumero(),
                filial.getCidade(), filial.getEstado(), filial.getEh5Estrelas());
